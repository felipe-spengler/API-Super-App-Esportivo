...
export function SumulaFutsal() {
    ...
    // 🛡️ Resilience Shield
    const { isOnline, syncing, addToQueue, registerSystemEvent, pendingCount } = useOfflineResilience(id, 'Futsal', async (action, data) => {
        let url = '';
        switch (action) {
    ...
    const handleEvent = (team: 'home' | 'away', type: any) => {
        ...
        if (type === 'foul') confirmEvent(null);
    ...
    const handleFinish = async () => {
        ...
        registerSystemEvent('user_action', 'Finalizou partida via Futsal');
        navigate(-1);
    };
            ...
            <div className="bg-gray-800 p-4 sticky top-0 z-10 shadow-lg border-b border-gray-700">
                <div className="flex items-center justify-between max-w-5xl mx-auto">
                    ...
                    <div className="text-center relative">
                        ...
                        <div className="flex items-center gap-2 justify-center text-orange-500 mb-1">
                            <Timer size={16} />
