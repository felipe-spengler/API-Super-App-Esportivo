            ...
            <div className="bg-gray-800 p-2 sticky top-0 z-10 shadow-lg border-b border-gray-700">
                <div className="flex items-center justify-between max-w-5xl mx-auto">
                    ...
                    <div className="text-center relative">
                        ...
                        <div className="flex items-center gap-1.2 justify-center text-emerald-500 -mb-1">
                            <Timer size={14} />
            ...
            <div className="p-2 max-w-5xl mx-auto space-y-3">
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="bg-gray-800 rounded-xl p-2 border border-blue-900/30 flex flex-col items-center text-center">
                        <h2 className="text-blue-400 font-bold text-[10px] uppercase italic truncate w-full mb-1">{matchData.home_team?.name}</h2>
                        <div className="text-4xl font-black mb-2">{homeScore}</div>
                    ...
                    <div className="bg-gray-800 rounded-xl p-2 border border-green-900/30 flex flex-col items-center text-center">
                        <h2 className="text-green-400 font-bold text-[10px] uppercase italic truncate w-full mb-1">{matchData.away_team?.name}</h2>
                        <div className="text-4xl font-black mb-2">{awayScore}</div>
                        <div className="grid grid-cols-2 gap-1 w-full">
