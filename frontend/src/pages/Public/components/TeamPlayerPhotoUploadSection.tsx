...
import { Camera, Loader2, Plus, Download, Trash2 } from 'lucide-react';
...
export function TeamPlayerPhotoUploadSection({ playerId, teamId, currentPhotos }: TeamPlayerPhotoUploadSectionProps) {
    ...
    async function handleDelete(index: number) {
        ...
        setUploadError(null);
        try {
            const endpoint = `/teams/${teamId}/delete-player-photo/${playerId}`;
            ...
            console.error('[TeamPlayerPhotoUpload] Delete Error:', error);
