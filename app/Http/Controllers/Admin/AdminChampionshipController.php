...
class AdminChampionshipController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //    If `store` method just does `create($validated)`, and $validated has `sport` string... but model doesn't have it in fillable... it might be ignored or throw if strict.
        //
        // HYPOTHESIS: The frontend expects a string for `sport`. The backend might be returning an object (relation) OR the column is missing.
        //
        ...
        //
        // I will modify the FRONTEND to render `camp.sport?.name || camp.sport` to resolve the "Objects are not valid as React child" crash.
        //
