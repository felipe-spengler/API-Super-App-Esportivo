...
$rodada = $_POST['rodada'] ?? " "; // Captura da rodada (Adicionado, estava faltando no código do zagueiro)
...
$caminho_fundo = '../assets/img/fundo_melhor_estreiante.jpg'; // Caminho do fundo ajustado
...
// O texto_categoria será preenchido para fins de nome do arquivo, mas não desenhado.
$texto_categoria = mb_strtoupper($categorias_titulos[$categoria] ?? 'MELHOR ESTREANTE', $encoding);
...
$y_rodada = $y_nome_campeonato + 50; // 50 pixels abaixo do campeonato

// Desenhar Categoria (REMOVIDO - para ficar como o zagueiro)
...
// Garante que o nome do arquivo use a categoria correta (Melhor Estreante)
