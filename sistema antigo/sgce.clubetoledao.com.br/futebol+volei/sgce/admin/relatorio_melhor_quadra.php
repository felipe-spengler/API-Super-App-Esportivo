...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Melhores em Quadra</li>
    </ol>
</nav>

<main class="container py-5">
    <div class="card">
        <div class="card-header"><i class="fas fa-crown text-success me-2"></i>Melhores em Quadra do Campeonato</div>
        <div class="card-body">
            <?php if (count($mvps) > 0): ?>
                                        ...
                                        if (!empty($partidas)):
                                            foreach ($partidas as $partida):
                                                ...
                                                <table class="table inner-table">
                                                    ...
                                                    WHERE se.id_partida = ? AND se.tipo_evento LIKE 'Ponto'
                                                    GROUP BY par.id, eq.id
                                                ...
                                                ";
                                                    ...
                                                    <?php if (!empty($gols_equipe_b)): ?>
                                                        <thead>
                                                            <tr>
                                                                <th colspan="4"><div class="equipe-b-header w-100">Ponto de <?= htmlspecialchars($partida['nome_equipe_b']) ?></div></th>
                                                            </tr>
                                                            <tr>
                                                                <th>Número</th>
                                                                <th>Jogador</th>
                                                ...
                                                <?php
                                                if (empty($gols_equipe_a) && empty($gols_equipe_b)) {
                                                    //echo '<div class="alert alert-info text-center">Nenhum gol registrado para esta partida.</div>';
                                                }
                                                ?>
                                            <?php endforeach; ?>
                                        <?php else: ?>
