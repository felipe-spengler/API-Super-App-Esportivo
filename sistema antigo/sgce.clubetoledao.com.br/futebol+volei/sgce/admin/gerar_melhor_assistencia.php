...
// --- 1. VALIDAÇÃO E CAPTURA DOS DADOS (AJUSTADA: APENAS JOGADOR E CATEGORIA) ---
if (
...
$rodada = $_POST['rodada'] ?? "RODADA"; // Definido como opcional/padrão
$id_jogador = $_POST['id_jogador'];
$categoria = $_POST['categoria'];

// Campos de partida (ignorados na busca/validação)
...
$caminho_fundo = '../assets/img/fundo_melhor_assistencia.jpg'; // <-- FUNDO CORRETO AQUI
...
function desenharBrasaoOuSigla($imagem_fundo, $equipe, $x, $y, $tamanho, $caminho_fonte, $cor_texto, $pasta_brasoes) {
    ...
    imagettftext($imagem_fundo, $tamanho_fonte, 0, $x_texto, $y_texto, $cor_preta, $caminho_fonte, $texto_sigla); // Usando cor preta para o fallback
}
...
$categorias_titulos = [
    ...
    'assistencia' => 'Melhor Assistência', // <-- Categoria alvo
    'volante' => 'Melhor Volante',
    'estreante' => 'Melhor Estreante',
    'zagueiro' => 'Melhor Zagueiro',
    'melhor_partida' => 'Melhor da Partida'
];
// Configura o texto da categoria
$texto_categoria = "";
...
// Desenhar Categoria (Mantida para consistência com o layout visual)
...
// Desenhar a rodada com contorno
foreach ($deslocamentos as $desloc) {
