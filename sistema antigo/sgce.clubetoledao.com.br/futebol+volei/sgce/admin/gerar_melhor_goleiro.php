...
if (
    ...
    // A validação agora exige apenas o ID do jogador e a categoria
...
try {
    // Busca apenas a equipe do jogador (como no código do zagueiro)
...
$caminho_fundo = '../assets/img/fundo_melhor_goleiro.jpg'; // <-- Caminho do fundo ajustado
...
// O texto_categoria será preenchido, mas não desenhado no topo
$texto_categoria = mb_strtoupper($categorias_titulos[$categoria] ?? 'MELHOR GOLEIRO', $encoding);
...
// Desenhar Categoria (REMOVIDO PARA FICAR NO FORMATO DO ZAGUEIRO)
