...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Pontuadores</li>
    </ol>
</nav>
                                ...
                                <tr class="body-event d-none">
                                    <td colspan="3">
                                        ...
                                        ?>
                                            ...
                                            <?php else: ?>
                                                <div class="alert alert-info text-center">Nenhum ponto registrado para este jogador nesta partida.</div>
                                            <?php endif; ?>
