...
$rodada = ""; // INICIALIZAÇÃO: Não usamos rodada para prêmios individuais sem partida
...
try {
    // Busca APENAS a equipe do jogador (Lógica corrigida e simplificada)
...
$caminho_fundo = '../assets/img/fundo_melhor_lateral.jpg'; // Fundo mantido
...
// Mapear a categoria para um título legível (Mantido para referência, mas não será usado no texto)
$categorias_titulos = [
...
// Ajuste conforme sua preferência: categoria deve ser uma string vazia
$texto_categoria = ""; 
