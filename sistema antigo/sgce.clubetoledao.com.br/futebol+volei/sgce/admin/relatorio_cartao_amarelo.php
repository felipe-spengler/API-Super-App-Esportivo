...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Cartões Amarelos</li>
    </ol>
</nav>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="caption-event <?= $row_class ?>">
                                    ...
                                    <td><?= htmlspecialchars($cartao['total_cartoes_amarelos']) ?></td>
                                </tr>
                                <tr class="body-event d-none">
                                    <td colspan="3">
                                        <?php
                                        // Busca as partidas onde este jogador recebeu cartões amarelos
                                        $sql_partidas = "
                                            SELECT DISTINCT
                                                p.id as id_partida,
                                        ...
                                        ?>
                                            ...
                                            <table class="table inner-table">
                                                <?php
                                                // Busca os cartões amarelos detalhados para a partida
                                                $sql_cartoes = "
                                                    SELECT 
                                                ...
                                                <?php if (!empty($cartoes_equipe_a)): ?>
                                                    <thead>
                                                        <tr>
                                                            <th colspan="4"><div class="equipe-a-header w-100">Cartões Amarelos de <?= htmlspecialchars($partida['nome_equipe_a']) ?></div></th>
                                                        </tr>
                                                        <tr>
                                                            <th>Número</th>
                                                            <th>Jogador</th>
                                                ...
                                                <?php if (!empty($cartoes_equipe_b)): ?>
                                                    <thead>
                                                        <tr>
                                                            <th colspan="4"><div class="equipe-b-header w-100">Cartões Amarelos de <?= htmlspecialchars($partida['nome_equipe_b']) ?></div></th>
                                                        </tr>
                                                        <tr>
                                                            <th>Número</th>
                                                            <th>Jogador</th>
                                            ...
                                            <?php if (empty($cartoes_equipe_a) && empty($cartoes_equipe_b)): ?>
                                                <div class="alert alert-info text-center">Nenhum cartão amarelo registrado para esta partida.</div>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                        <?php else: ?>
