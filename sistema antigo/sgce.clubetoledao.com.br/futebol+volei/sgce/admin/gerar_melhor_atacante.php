...
// --- 1. VALIDAÇÃO E CAPTURA DOS DADOS (AJUSTADA) ---
// Removemos a obrigatoriedade de id_equipe_a, id_equipe_b e placar, mas os mantivemos no POST
// para compatibilidade com o formulário, caso ainda estejam sendo enviados.
if (
...
$rodada = $_POST['rodada'] ?? "RODADA"; // Captura da rodada
$id_jogador = $_POST['id_jogador'];
$categoria = $_POST['categoria'];

// Variáveis não usadas na arte individual, mas presentes no POST (pode ser ignorado)
...
try {
    // Busca APENAS a equipe do jogador, ignorando id_equipe_a e id_equipe_b
...
$caminho_fundo = '../assets/img/fundo_melhor_atacante.jpg'; // <-- FUNDO ATACANTE
...
$categorias_titulos = [
    ...
    'meia' => 'Melhor Meia',
    'atacante' => 'Melhor Atacante', // <-- Categoria alvo
