...
// 2. Busca os jogadores com pontos de saque
$sql_eventos = "
    SELECT 
    ...
    WHERE p.id_campeonato = ? 
      AND se.tipo_evento LIKE 'Ponto de Saque%'
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Pontos de Saque</li>
    </ol>
</nav>

<main class="container py-5">
    <div class="card">
        <div class="card-header"><i class="fas fa-volleyball-ball me-2"></i>Pontos de Saque do Campeonato</div>
        <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr class="body-event d-none">
                                    <td colspan="3">
                                        <?php
                                        // Busca as partidas onde este jogador teve pontos de saque
                                        $sql_partidas = "
                                            SELECT DISTINCT
                                                p.id as id_partida,
                                        ...
                                        ?>
                                            ...
                                            <?php
                                            // Busca os pontos de saque detalhados do jogador nesta partida
                                            $sql_pontos = "
                                                SELECT 
                                                    se.id,
                                            ...
                                            <?php else: ?>
                                                <div class="alert alert-info text-center">Nenhum ponto de saque registrado nesta partida.</div>
                                            <?php endif; ?>

                                        <?php endforeach; ?>
                                        <?php else: ?>
                                            <div class="alert alert-info text-center">Nenhum ponto de saque registrado para este jogador.</div>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
            ...
            <?php else: ?>
                <div class="alert alert-secondary text-center">Nenhum ponto de saque foi registrado para este campeonato.</div>
            <?php endif; ?>
        </div>
    </div>
</main>
