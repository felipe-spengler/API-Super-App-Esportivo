...
<div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="relatorio_classificacao_volei.php?id_categoria=<?= htmlspecialchars($campeonato['id']) ?>" style="text-decoration: none;" class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="relatorio_pontuador_volei.php?id_categoria=<?= htmlspecialchars($campeonato['id']) ?>" style="text-decoration: none;" class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="relatorio_bloqueador_volei.php?id_categoria=<?= htmlspecialchars($campeonato['id']) ?>" style="text-decoration: none;" class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="relatorio_ace_volei.php?id_categoria=<?= htmlspecialchars($campeonato['id']) ?>" style="text-decoration: none;" class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="relatorio_melhor_quadra.php?id_categoria=<?= htmlspecialchars($campeonato['id']) ?>" style="text-decoration: none;" class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs fw-bold text-secundary text-uppercase mb-1">Melhor em Quadra</div>
                        <div class="h5 mb-0 fw-bold text-gray-800"></div>
                    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="menu_gerar_arte_volei.php?id_categoria=<?= htmlspecialchars($campeonato['id']) ?>" style="text-decoration: none;" class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
