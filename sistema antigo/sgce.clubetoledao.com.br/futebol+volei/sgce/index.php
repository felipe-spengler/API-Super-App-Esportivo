            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <?php
                            // Se o ID do esporte for 2 (Vôlei), usa o caminho específico.
                            if ($esporte['id'] == 2) {
                                $caminho_menu = '../volei/menu_campeonatos.php'; // Volta 1 pasta e entra em volei/
                            } else {
                                $caminho_menu = 'menu_campeonatos.php'; // Mantém o caminho padrão
                            }
                        ?>
                        <a href="<?= $caminho_menu ?>?id_esporte=<?= $esporte['id'] ?>" class="btn btn-outline-primary w-100">Ver Detalhes</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
