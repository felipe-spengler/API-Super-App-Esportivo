                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr class="body-event d-none">
                                    <td colspan="3">
                                        <?php
                                        // Busca as partidas onde este jogador marcou gols
                                        $sql_partidas = "
                                            SELECT DISTINCT
                                                p.id as id_partida,
                                        ...
                                        <?php endforeach; ?>
                                        <?php else: ?>
                                            <div class="alert alert-info text-center">Nenhum gol registrado para este jogador.</div>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
