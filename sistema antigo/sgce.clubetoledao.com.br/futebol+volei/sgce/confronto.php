...
// --- INÍCIO DO BLOCO DE ORDENAÇÃO DE RODADAS ---
// 1. Mapeamento de Fases Finais para Prioridade (Base 1000)
...
$comparador_rodadas = function($a_chave, $b_chave) use ($prioridade_fases_finais) {
    ...
    $get_prioridade = function($chave) use ($prioridade_fases_finais) {
        ...
        // Tratar "3º e 4º" ou "Disputa 3º" de forma robusta
        ...
        // 3. FASES NÃO NUMERADAS / OUTRAS (Prioridade neutra)
        return 500; 
    };
...
// --- FIM DO BLOCO DE ORDENAÇÃO DE RODADAS ---
